...
2. **Ripristina Vercel**: In **Settings > Build & Development** su Vercel, imposta **Ignored Build Step** su "Auto".
...
_Esempio:_ `git commit -m "feat: aggiunta animazione 3D alla hero"` -> Nel README apparirà come novità.
